...
class MakeContractCommand extends Command
{
    ...
    public function getStubVariables():array
    {
        return [
            ...
            'CLASS_NAME'        => 'I'.$this->getSingularClassName($this->argument('name')),
        ];
    }
    ...
    {
        return base_path('app/Http/Contracts') .'/' .'I'.$this->getSingularClassName($this->argument('name')) .'Service'. 'Contract.php';
    }
