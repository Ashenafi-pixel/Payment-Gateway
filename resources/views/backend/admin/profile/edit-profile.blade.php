...
@section('content')
    ...
    <div class="row gy-3 mt-1">
        ...
        <div class="col-md-4 animated slideInUp">
            @include('backend.admin.profile.__show-profile')
        </div>
        <!--profile forms---->
...
{{--                    </li>--}}
                ...
                <!-- Tab panes -->
                <div class="tab-content custom-fields mt-4">
                    @include('backend.admin.profile.__profile-update')
                    @include('backend.admin.profile.__password-update')
{{--                    @include('backend.admin.profile.__pin-code')--}}
                </div>
            </div>
        </div>
