<div class="flex-mode gap-2  justify-content-lg-end">
    <button class="btn btn-gold flex-mode" data-bs-toggle="modal" data-bs-target="#importStudent">
    ...
    <a class="btn btn-theme flex-mode gap-2"
       href="{{ route(\App\Helpers\IUserRole::MERCHANT_ROLE.'.student.create.form') }}">
        <span class="material-symbols-outlined">
            add
        </span>
        {{ __('Add Student') }}
    </a>
    {{--    <form action="{{ route(\App\Helpers\IUserRole::MERCHANT_ROLE.'.students.import') }}" class="ajax" method="POST" enctype="multipart/form-data">--}}
    {{--        @csrf--}}
...
<!-- Modal -->
<div class="modal animated zoomIn" id="importStudent" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            {!! Form::open(['url'=> route(\App\Helpers\IUserRole::MERCHANT_ROLE.'.students.import'),'class' => 'ajax',
